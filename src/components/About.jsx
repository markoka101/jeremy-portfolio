		...
		>
			<div className="mt-20 flex w-full flex-col px-10 text-white font-inter sm:px-12 lg:w-1/2">
				...
				<p className="md:text-lg">
					Hi, I’m Jeremy Messina— a photographer with a deep love for capturing real moments, honest
					emotions, and the beauty in the everyday. My journey behind the lens started with a
					curiosity for light and storytelling, and over the years, it’s grown into a full-blown
					...
					create images that feel personal, timeless, and true. When I’m not behind the camera, you
					can usually find me at a trendy restaurant or hanging out with my friends. Thanks for
					being here — I’m glad that you are.
				</p>
			</div>
