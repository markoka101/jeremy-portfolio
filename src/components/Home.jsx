...
export default function Home() {
	...
	return (
		<>
			<Helmet>
				<title>Jeremy Messina | Freelance Photographer</title>
				<meta
					name="description"
					content="Jeremy Messina is a freelance photographer capturing real moments, honest emotions, and the beauty in the everyday. Explore the portfolio and book your session today."
				/>
				<meta property="og:title" content="Jeremy Messina | Freelance Photographer" />
				<meta
					property="og:description"
					content="Capturing timeless images in studio, outdoors, and at events. Discover the portfolio and book your next session."
				/>
